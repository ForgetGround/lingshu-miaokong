...
class ResNet18EMGClassifier(nn.Module):
    def __init__(self, num_classes: int, in_channels: int = 1, dropout: float = 0.0) -> None:
        super().__init__()
        self.in_channels = 64
...
def resnet18(num_classes: int, dropout: float = 0.0) -> ResNet18EMGClassifier:
    return ResNet18EMGClassifier(num_classes=num_classes, dropout=dropout)


def create_model(num_classes: int, dropout: float = 0.0) -> ResNet18EMGClassifier:
