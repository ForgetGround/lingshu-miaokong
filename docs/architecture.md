...
硬件目录提供一个基于 `ESP32-S3-WROOM-1-N16R8` 模块的参考核心板说明。当前硬件包含 8 路 EMG/FPC 输入、AD8226 + TL084 ADC/EMG 放大器、USB-C、电池供电/充电、电源开关和 5 指关节驱动输出。该方案用于说明采集链路和接口，不等同于已完成量产的 PCB 设计。
